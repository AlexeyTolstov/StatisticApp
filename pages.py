...
class InterestsPage(FloatLayout):
    ...
    def isCanNext(self):
        ...
        if not interesting:
            self.interesting_label_not.text = "Выберете больше 0 и меньше 3"
        else:
            self.interesting_label_not.text = ""

        if not favorite:
            self.favorite_section_label_not.text = "Выберете больше 0 и меньше 3"
        else:
            self.favorite_section_label_not.text = ""

        if not rest:
            self.rest_label_not.text = "Выберете больше 0 и меньше 3"
        else:
            self.rest_label_not.text = ""

        return interesting and favorite and rest
